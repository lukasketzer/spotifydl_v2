...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", "--fix_missing", default=False, help="""If flag is set, already downloaded songs will not be replaced but skipped. Only missing songs will
    will be downloaded. default == False""", type=bool)
